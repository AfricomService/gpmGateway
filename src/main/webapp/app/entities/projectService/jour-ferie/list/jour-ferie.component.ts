...
import { EntityArrayResponseType, JourFerieService } from '../service/jour-ferie.service';
...
export class JourFerieComponent implements OnInit {
  ...
  trackId = (_index: number, item: IJourFerie): number => this.jourFerieService.getJourFerieIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.jourFeries = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IJourFerie[] | null): IJourFerie[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.jourFerieService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
