...
export class AgenceService {
  ...
  findByClientId(clientId: number): Observable<EntityArrayResponseType> {
    return this.http
      .get<RestAgence[]>(`${this.resourceUrl}/client/${clientId}`, { observe: 'response' })
      .pipe(map(res => this.convertResponseArrayFromServer(res)));
  }
  ...
  searchByClientId(clientId: number, designation: string): Observable<EntityArrayResponseType> {
    ...
    return this.http
      .get<RestAgence[]>(`${this.resourceUrl}/client/${clientId}/search`, { params: options, observe: 'response' })
      .pipe(map(res => this.convertResponseArrayFromServer(res)));
  }
