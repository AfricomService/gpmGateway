...
describe('Vehicule Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'vehicule', component: VehiculeComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.vehicules?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
