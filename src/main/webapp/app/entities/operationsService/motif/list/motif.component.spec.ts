...
describe('Motif Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'motif', component: MotifComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.motifs?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });
