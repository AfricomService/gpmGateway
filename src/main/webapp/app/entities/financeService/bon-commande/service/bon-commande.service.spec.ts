...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../bon-commande.test-samples';

import { BonCommandeService, RestBonCommande } from './bon-commande.service';

const requireRestSample: RestBonCommande = {
  ...sampleWithRequiredData,
  dateBonCommande: sampleWithRequiredData.dateBonCommande?.toJSON(),
};
...
describe('BonCommande Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a BonCommande', () => {
      ...
      const bonCommande = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(bonCommande).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a BonCommande', () => {
      const bonCommande = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(bonCommande).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addBonCommandeToCollectionIfMissing', () => {
      it('should add a BonCommande to an empty array', () => {
        const bonCommande: IBonCommande = sampleWithRequiredData;
      ...
      it("should add a BonCommande to an array that doesn't contain it", () => {
        const bonCommande: IBonCommande = sampleWithRequiredData;
        const bonCommandeCollection: IBonCommande[] = [sampleWithPartialData];
        expectedResult = service.addBonCommandeToCollectionIfMissing(bonCommandeCollection, bonCommande);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(bonCommande);
      });
      ...
      it('should add only unique BonCommande to an array', () => {
        const bonCommandeArray: IBonCommande[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const bonCommandeCollection: IBonCommande[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const bonCommande: IBonCommande = sampleWithRequiredData;
        const bonCommande2: IBonCommande = sampleWithPartialData;
    ...
    describe('compareBonCommande', () => {
      it('Should return true if both entities are null', () => {
        const entity1 = null;
        const entity2 = null;

        const compareResult = service.compareBonCommande(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareBonCommande(entity1, entity2);
        const compareResult2 = service.compareBonCommande(entity2, entity1);
