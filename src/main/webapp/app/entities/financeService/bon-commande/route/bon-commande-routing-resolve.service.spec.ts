...
describe('BonCommande routing resolve service', () => {
  ...
  let resultBonCommande: IBonCommande | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultBonCommande).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IBonCommande>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
