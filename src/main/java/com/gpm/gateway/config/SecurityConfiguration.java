package com.gpm.gateway.config;
...
import com.gpm.gateway.security.SecurityUtils;
import com.gpm.gateway.security.oauth2.AudienceValidator;
import com.gpm.gateway.security.oauth2.JwtGrantedAuthorityConverter;
import com.gpm.gateway.web.filter.SpaWebFilter;
...
public class SecurityConfiguration {
    ...
    public SecurityWebFilterChain springSecurityFilterChain(ServerHttpSecurity http) {
        ...
        http.oauth2Login(oauth2 -> oauth2
                ...
                .authenticationSuccessHandler(new RedirectServerAuthenticationSuccessHandler("/gpm/"))
            )
